...
public class InstagramTest {
  ...
  public void instagram() throws InterruptedException{
    ...
    vars.put("win5758", waitForWindow(2000));
    driver.switchTo().window(vars.get("win5758").toString());
    Thread.sleep(4000);
    assertEquals(driver.getCurrentUrl(),"https://www.instagram.com/coral.computers/?hl=en");
    
    String string ="\nNaziv testa : Instagram test \n"+
            "Opis testa: Proveravanje linka prema Instagram stranici \n"+
  "\nTest je uspesan \n\n";
