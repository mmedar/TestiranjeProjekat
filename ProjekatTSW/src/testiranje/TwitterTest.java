...
public class TwitterTest {
  ...
  public void twitter() throws InterruptedException {
    ...
    driver.findElement(By.cssSelector(".fa-twitter-square")).click();
    vars.put("win7305", waitForWindow(2000));
    driver.switchTo().window(vars.get("win7305").toString());
    Thread.sleep(4000);
    assertEquals(driver.getCurrentUrl(),"https://twitter.com/CoralComputers");
    
    String string ="\nNaziv testa : Twitter test \n"+
            "Opis testa: Proveravanje linka prema Twitter stranici \n"+
  "\nTest je uspesan \n\n";
